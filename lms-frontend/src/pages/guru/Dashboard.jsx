...
import { getCurrentUser, getDashboardGuru } from '../../mocks/academicMock';
...
const GuruDashboard = () => {
  ...
  useEffect(() => {
    ...
    if (user && user.role === 'guru') {
      const data = getDashboardGuru(user.id);
  ...
  const stats = [
    ...
    {
      title: 'Total Tugas',
      value: dashboardData.totalTugas.toString(),
      icon: ClipboardList,
      iconBgColor: 'bg-green-100',
      iconColor: 'text-green-600',
      trend: 0,
      trendLabel: `${dashboardData.activeTugas} aktif`,
    },
    {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        {/* Aktivitas Terkini — dari materi & tugas mock */}
        <Card>
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold text-gray-900 flex items-center gap-2">
