...
const Statistik = () => {
  ...
  const growthData = [
    { label: 'Siswa Baru', value: 120, change: '+8%', positive: true },
    { label: 'Guru Baru', value: 5, change: '+12%', positive: true },
    { label: 'Materi Upload', value: 45, change: '+15%', positive: true },
    { label: 'Avg Kehadiran', value: '89.5%', change: '-2%', positive: false },
  ];

  const jurusanStats = [
    { nama: 'RPL', siswa: 450, guru: 18, kelas: 15, percentage: 38 },
    { nama: 'TKJ', siswa: 380, guru: 15, kelas: 12, percentage: 32 },
    { nama: 'Multimedia', siswa: 359, guru: 12, kelas: 9, percentage: 30 },
  ];

  const kelasStats = [
    { tingkat: 'XII', total: 420, lulus: 400, avgNilai: 85.5 },
    { tingkat: 'XI', total: 398, lulus: '-', avgNilai: 82.3 },
    { tingkat: 'X', total: 371, lulus: '-', avgNilai: 78.9 },
  ];
  ...
  const performanceByMonth = [
    ...
    { bulan: 'Jun', avgNilai: 85, kehadiran: 92 },
  ];
            ...
            {jurusanStats.map((jurusan, index) => (
              <div key={index}>
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm font-medium text-gray-900">{jurusan.nama}</span>
                  <span className="text-sm text-gray-600">
                    {jurusan.siswa} siswa • {jurusan.guru} guru
                  </span>
                </div>
                ...
                <div className="flex items-center justify-between mt-1">
                  ...
                  <span className="text-xs text-gray-500">{jurusan.kelas} kelas</span>
                </div>
              </div>
            ))}
          </div>
