          ...
          <div className="mt-4 p-4 bg-white rounded-xl border border-gray-200 shadow-sm">
            ...
            <div className="space-y-1.5 text-xs text-gray-600">
              <div className="flex justify-between items-center">
                ...
                <span className="text-gray-500">admin@test.local / password</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="font-medium">Guru:</span>
                <span className="text-gray-500">guru@test.local / password</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="font-medium">Siswa:</span>
                <span className="text-gray-500">siswa@test.local / password</span>
              </div>
            </div>
          </div>
        </div>
